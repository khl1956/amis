...
-- INSERT USERINSERT INTO "USER" ("ROLE", "EMAIL","LOGIN","PASSWORD","DRIVER_LICENCE","NUMBER_DRIVER_LICENCE", "FIRSTNAME", "LASTNAME","PHONE_NUMBER","BIRTHDAY", "RATING")VALUES ('User', 'user_2@gmail.com', 'user_2', 'pass_2', TO_DATE('2016/06/01','yyyy/mm/dd'), 'AAA123456', 'firstname_2', 'lastname_2', '0501234567', TO_DATE('1990/05/01','yyyy/mm/dd'), '5');
-- INSERT USERINSERT INTO "USER" ("ROLE", "EMAIL","LOGIN","PASSWORD","DRIVER_LICENCE","NUMBER_DRIVER_LICENCE", "FIRSTNAME", "LASTNAME","PHONE_NUMBER","BIRTHDAY", "RATING")VALUES ('User', 'user_2@gmail.com', 'user_2', 'pass_2', TO_DATE('2016/06/01','yyyy/mm/dd'), 'AAA133456', 'firstname_2', 'lastname_2', '0501233567', TO_DATE('1990/05/01','yyyy/mm/dd'), '5');
