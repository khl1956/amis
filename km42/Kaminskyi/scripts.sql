...
select "ROLE", "EMAIL", "LOGIN"
from "USER";

-- INSERT USER
INSERT INTO "USER" ("ROLE", "EMAIL","LOGIN","PASSWORD","DRIVER_LICENCE","NUMBER_DRIVER_LICENCE", "FIRSTNAME", "LASTNAME","PHONE_NUMBER","BIRTHDAY", "RATING")
VALUES ('User', 'user_1@gmail.com', 'user_2', 'pass_2', TO_DATE('2016/06/01','yyyy/mm/dd'), 'AAA123456', 'firstname_1', 'lastname_1', '0501234567', TO_DATE('1990/05/01','yyyy/mm/dd'), '5');